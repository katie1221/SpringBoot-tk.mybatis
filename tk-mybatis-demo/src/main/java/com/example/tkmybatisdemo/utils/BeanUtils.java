...
public class BeanUtils<T> {
    ...
    public static void forceSetProperty(Object object, String propertyName, Object newValue) {
        if (null == object || Tools.isEmpty(propertyName)) {
            return;
        }
    ...
    public static Object getValueByType(Class cls, Object defObj) {
        ...
        if (className.indexOf("[") == 0) {
            ...
            if (className.indexOf("String") >= 0) {
                ...
                if (null == defObj || Tools.isEmpty(String.valueOf(defObj))) {
                    defObj = "0";
                }
                ...
                if (null != defObj && Tools.notEmpty(String.valueOf(defObj))) {
    ...
    public static Object getStringToType(Class typeClass, String value) {
        ...
        if (typeClass.equals(String.class)) {
            if (null == value || Tools.isEmpty(value)) {
                obj = "";
            } else {
